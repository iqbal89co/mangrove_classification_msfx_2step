...
def main():
    ...
    OUT_RF = f"models/resnet50_rf_ds{args.dataset}_best.pkl"
    
    # TensorBoard
    run_name = f"resnet50_rf_ds{args.dataset}_{datetime.now().strftime('%Y%m%d-%H%M%S')}"
    ...
    # ----- Stage 2: Random Forest on ResNet50 features -----
    ...
    writer.add_scalar("RF/TrainingTime", training_time, global_step)
    ...
    writer.add_scalar("RF/TestingTime", testing_time, global_step)
