...
def main():
    ...
    # TensorBoard
    run_name = f"resnet50_xgb_ds{args.dataset}_{datetime.now().strftime('%Y%m%d-%H%M%S')}"
    ...
    # ----- Stage 2: XGBoost on ResNet50 features -----
    ...
    writer.add_scalar("XGB/TrainingTime", training_time, global_step)
