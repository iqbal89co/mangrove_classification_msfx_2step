...
def main():
    ...
    OUT_SVM = f"models/resnet50_svm_ds{args.dataset}_best.pkl"
    
    # TensorBoard
    run_name = f"resnet50_svm_ds{args.dataset}_{datetime.now().strftime('%Y%m%d-%H%M%S')}"
    ...
    # ----- Stage 2: SVM on ResNet50 features -----
    ...
    writer.add_scalar("SVM/TrainingTime", training_time, global_step)
    ...
    writer.add_scalar("SVM/TestTime", test_time, global_step)
